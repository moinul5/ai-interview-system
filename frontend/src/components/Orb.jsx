 ...
 * Orb.jsx
 * -------
 * React Bits — Orb background component (JS-TW variant).
 * Source: https://reactbits.dev/backgrounds/orb
 * Adapted: removed external CSS import; uses inline style for container sizing.
...
export default function Orb({
  ...
  useEffect(() => {
    ...
    // Make canvas cover the container completely
    ...
    // Delay first resize by one rAF so the DOM is painted and
  ...
  return (
    ...
    >
      {/* Inner div is the actual GL container — must have real px dimensions */}
      <div
        ref={ctnDom}
        style={{
          position: 'absolute',
